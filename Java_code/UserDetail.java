...
public class UserDetail extends javax.swing.JFrame {
    ...
    ResultSet rs;
    String stri;
    public UserDetail( String str) throws SQLException {
        initComponents();
        con=ConDb.conLink();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(104, 104, 104)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tf_a, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tf_e, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tf_m, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tf_n, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tf_u, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(187, 187, 187)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            stmt=con.prepareStatement("select login_username from user_login where login_username=?");
           stmt.setString(1,tf_u.getText());
           rs=stmt.executeQuery();
           if(rs.next()){
               
           stmt=con.prepareStatement("insert into com_user values(?,?,?,?,?)");
           stmt.setString(1,tf_n.getText());
           stmt.setString(2,tf_m.getText());
           stmt.setString(3,tf_e.getText());
           stmt.setString(4,tf_a.getText());
           stmt.setString(5,tf_u.getText());
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
     (new CoordinatorLogin(stri)).setVisible(true);   // TODO add your handling code here:
